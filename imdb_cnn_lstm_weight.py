...
# the timedistributeddense dimention can be changed to the attention space dimension
model.add_node(TimeDistributedDense(lstm_output_size),name='forwarddense',input='forward')
model.add_node(TimeDistributedDense(lstm_output_size),name='backwarddense',input='backward')
model.add_node(TimeDistributedDense(lstm_output_size),name='localdense',input='local')
model.add_node(LSTM(lstm_output_size), name='lstm', inputs=['forwarddense', 'backwarddense','localdense'])
# maybe several dense layers
